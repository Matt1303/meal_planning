...
class RecipeExtractor:
        ...
        for filename in os.listdir(self.html_dir):
            if filename.endswith('.html'):
                with open(os.path.join(self.html_dir, filename), 'r', encoding='utf-8') as file:
                    ...
                    self.store_data(title, filtered_ingredients, category, rating, servings, difficulty)
    ...
    def store_data(self, title, ingredients, category, rating, servings, difficulty):
        self.recipes.append({
            "Title": title,
    ...
    def store_all_recipes(self):
        recipes_dict = {recipe["Title"]: {"Ingredients": recipe["Ingredients"], "Categories": recipe["Categories"], "Rating": recipe["Rating"], "Servings": recipe["Servings"], "Difficulty": recipe["Difficulty"]} for recipe in self.recipes}
        return recipes_dict
